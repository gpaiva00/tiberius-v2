...
function Footer() {
  return (
    <footer className="flex w-full items-center justify-between bg-white px-4 py-2 dark:bg-zinc-900">
      <div className="flex items-center gap-2">
        <Link
          to={HOME_ROUTE}
          className="flex items-center gap-1 text-xs font-semibold text-zinc-700 underline-offset-4 hover:underline dark:text-zinc-500 md:text-sm"
        >
          <ListChecks size={16} />
          Tiberius
      ...
      <div className="flex items-center gap-6 md:gap-10">
        <Link
          to={HELP_ROUTE}
          className="text-xs text-zinc-500 underline-offset-4 hover:underline dark:text-zinc-500 md:text-sm"
        >
          Ajuda
        </Link>
        <Link
